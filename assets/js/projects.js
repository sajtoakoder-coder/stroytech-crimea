  ...
  */
  var PROJECTS = [
    ...
    },
    {
      ...
      short: 'Двухэтажный коттедж с классическим фасадом и ухоженной территорией.',
      desc: 'Двухэтажный коттедж с классическим архитектурным решением. Симметричный фасад, декоративные элементы, просторные комнаты и качественная отделка. Проект реализован под ключ.',
      cover: 'assets/img/project11/project11',
      gallery: [
        'assets/img/project11/project11'
      ],
      plans: [
        { label: 'План', src: 'assets/img/project11/2dplan.webp' }
      ],
      specs: [
        ['Этажность', '2 этажа'],
        ['Расположение', 'Крым']
    ...
    {
      badge: 'Проект №12',
      title: 'Трёхэтажный коттедж',
      short: 'Трёхэтажный коттедж с панорамным остеклением и просторными террасами.',
      desc: 'Трёхэтажный коттедж с современным фасадом, панорамным остеклением и террасами на каждом этаже. Проект реализован под ключ.',
      cover: 'assets/img/project12/project12',
      gallery: [
        'assets/img/project12/project12'
      ],
      plans: [
    ...
    {
      badge: 'Проект №13',
      title: 'Современный коттедж с террасой',
      short: 'Двухэтажный коттедж в современном стиле с открытой террасой.',
      desc: 'Двухэтажный коттедж в стиле современного минимализма. Открытая терраса, панорамное остекление, качественная отделка фасада. Проект реализован под ключ.',
      cover: 'assets/img/project13/project13',
      gallery: [
        'assets/img/project13/project13'
      ],
      plans: [
    ...
    {
      badge: 'Проект №14',
      title: 'Коттедж с открытой планировкой',
      short: 'Современный коттедж с открытой планировкой и продуманным зонированием.',
      desc: 'Коттедж с открытой планировкой первого этажа, просторной гостиной-кухней и выходом на террасу. Продуманное зонирование, качественные материалы. Проект реализован под ключ.',
      cover: 'assets/img/project14/project14',
      gallery: [
        'assets/img/project14/project14'
      ],
      plans: [
    ...
    },
    {
      badge: 'Проект №15',
      title: 'Виг вамы',
      short: 'Современный коттедж.',
      desc: 'Современный коттедж, реализованный под ключ в Крыму.',
