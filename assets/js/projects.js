...
(function () {
  ...
  */
  var PROJECTS = [
    ...
    {
      badge: 'Проект №20',
      title: 'Трёхэтажная вилла с видом на море',
      short: 'Современная вилла с панорамным остеклением, террасами и детской площадкой.',
      desc: 'Трёхэтажная вилла на склоне с панорамным видом на море и горы. Каждый этаж имеет собственную террасу с остеклением в пол. Придомовая территория благоустроена: парковка, ландшафтный дизайн и детская площадка. Реализована под ключ.',
